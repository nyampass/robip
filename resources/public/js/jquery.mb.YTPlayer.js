...
//extend checkmobile
jQuery.fn.ifMobile = function(){

//スマートフォンチェック
//$.browserではなく、本プラグインにて実装しているメソッドです。
...
//ポジションとか大きさとか
//下記を全て削除して、.YTPUnderlayにスタイルを付与刷るほうがいいかもです。
//background-size:"cover"はサポートしているブラウザの確認が必要です。
...
"height": "100%",
 ...
 //クラス付与
//独自のクラス名なので、デザインを変更したい場合は、
//.YTPUnderlayにスタイルを記述してください。
//もちろんクラス名は任意につけていただけます。
.addClass("YTPUnderlay");

//body直下に挿入
underlay.prependTo('body');
}