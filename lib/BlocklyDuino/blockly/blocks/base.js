...
Blockly.Blocks['inout_serial_write'] = {
    init: function() {
...
Blockly.Blocks['inout_infrared_send'] = {
  init: function() {
    this.appendValueInput("NAME")
        .setCheck("String")
	.appendField("infrared send");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(190);
  }
...
Blockly.Blocks['web_http_access'] = {
  init: function() {
    this.appendValueInput("NAME")
        .setCheck("String")
	.appendField("http access");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(340);
  }
...
Blockly.Blocks['web_read_http_access'] = {
  init: function() {
    this.appendValueInput("NAME")
        .setCheck("String")
	.appendField("read http access");
    this.setOutput(true, 'String');
    this.setColour(340);
  }
};

Blockly.Blocks['inout_motion_sensor_select'] = {
    init: function() {
        this.appendDummyInput()
            .appendField("sensor")
            .appendField(new Blockly.FieldDropdown([["accelerator_x", "accelerator_x"],
						    ["accelerator_y", "accelerator_y"],
						    ["accelerator_z", "accelerator_z"],
						    ["accelerator_complex", "accelerator_complex"]]), "AXIS");
        this.setOutput(true, "Number");
        this.setColour(190);
    }
};
