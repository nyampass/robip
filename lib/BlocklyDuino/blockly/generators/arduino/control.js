...
Blockly.Arduino.controls_dotimes = function() {
  var countVar = Blockly.Arduino.variableDB_.getDistinctName('count', Blockly.Variables.NAME_TYPE);
  var loopVar = Blockly.Arduino.variableDB_.getDistinctName('i', Blockly.Variables.NAME_TYPE);
  var count = Blockly.Arduino.valueToCode(this, 'COUNT', Blockly.Arduino.ORDER_ASSIGNMENT) || '0';
  var branch = Blockly.Arduino.statementToCode(this, 'DO');

  return 'for (int ' + loopVar + ' = 0; ' + loopVar + ' < ' + count + '; ' + loopVar + '++) {\n' + branch + '}\n';
};

Blockly.Arduino.controls_infinite_loop = function() {
  var branch = Blockly.Arduino.statementToCode(this, 'DO');
